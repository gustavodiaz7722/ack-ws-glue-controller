...
// +kubebuilder:rbac:groups=glue.services.k8s.aws,resources=jobs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=glue.services.k8s.aws,resources=jobs/status,verbs=get;update;patch
